...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    subtitle:
      "Acompanhe entradas, saídas, consumo, localização e níveis mínimos de estoque.",
  ...
  },
  {
    ...
    subtitle:
      "Organize contas a pagar e receber, fluxo de caixa, bancos e previsões financeiras.",
...
/* Ícones próprios em SVG — traço consistente (stroke 1.6, cantos arredondados) */
const ICONS: React.ReactNode[] = [
  // Atendimento: cliente, veículo e histórico conectados
  <svg key="i1" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-7 w-7">
  ...
  <svg key="i2" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-7 w-7">
    ...
    <path d="M4 21.5a3.5 3.5 0 0 0 4.9 4.4l-1.2-2.4 1.7-1.7 2.4 1.2A3.5 3.5 0 0 0 7.4 18" opacity="0.9" />
  </svg>,
  // Estoque: caixa, peça, código e alerta
  <svg key="i3" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-7 w-7">
  ...
  <svg key="i4" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-7 w-7">
  ...
  <svg key="i5" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-7 w-7">
  ...
  <svg key="i6" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-7 w-7">
...
const SOLUTIONS = [
  ...
  { name: "Operação", benefit: "Serviços, etapas e prazos sob controle." },
  ...
  return (
    <div className="w-[150px] md:w-[175px] shrink-0 text-center">
      ...
      <svg viewBox="0 0 200 122" className="w-full" aria-hidden="true">
        {/* trilha */}
        <path d="M 24 104 A 76 76 0 0 1 176 104" fill="none" stroke="rgba(255,255,255,0.12)" strokeWidth="7" strokeLinecap="round" pathLength={100} />
        {/* progresso vermelho */}
        <path d="M 24 104 A 76 76 0 0 1 176 104" fill="none" stroke={RED} strokeWidth="7" strokeLinecap="round" pathLength={100} strokeDasharray={100} strokeDashoffset={100 - frac * 100} className="sfp-arc" />
        {/* riscos e numeração */}
        {ticks.map((f, i) => {
          ...
          return (
            <g key={i}>
              <line x1={p1.x} y1={p1.y} x2={p2.x} y2={p2.y} stroke={f <= frac + 0.001 ? RED : "rgba(255,255,255,0.35)"} strokeWidth="2" strokeLinecap="round" />
              <text x={pl.x} y={pl.y + 3} textAnchor="middle" fontSize="9" fill="rgba(255,255,255,0.5)" fontFamily="Inter, sans-serif">
                {tickLabel(i)}
              </text>
            </g>
          );
        ...
        {/* ponteiro */}
        <g className="sfp-needle" style={{ transform: `rotate(${angle}deg)`, transformOrigin: "100px 104px" }}>
          <line x1="100" y1="104" x2="100" y2="42" stroke={RED} strokeWidth="3" strokeLinecap="round" />
        </g>
        <circle cx="100" cy="104" r="7" fill="#111318" stroke={RED} strokeWidth="2" />
        {/* valor central */}
        <text x="100" y="94" textAnchor="middle" fontSize="17" fontWeight="700" fill="#ffffff" fontFamily="Inter, sans-serif">
          {center}
        </text>
      </svg>
      {sub && (
      ...
      <div className="container-x mx-auto max-w-[1200px]">
        ...
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-ink-soft leading-relaxed">
            Explore as soluções do Super Fast e descubra como transformar
            controle, produtividade e informação em resultado para sua oficina.
          </p>
        </div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-[#15171c] p-5 shadow-[0_24px_60px_-24px_rgba(0,0,0,0.45)] md:p-8">
          ...
          <div aria-hidden="true" className="pointer-events-none absolute left-1/2 top-0 h-48 w-[560px] -translate-x-1/2 rounded-full bg-primary/10 blur-3xl" />
          ...
          <div className="relative grid items-center gap-5 lg:grid-cols-[185px_minmax(0,1fr)_185px]">
            ...
            <div className="mx-auto w-full max-w-[720px]">
              <div className="flex items-center justify-center gap-3 md:gap-5">
                ...
                <div className="w-full max-w-[350px] rounded-2xl border border-white/10 bg-black p-4 shadow-[inset_0_0_24px_rgba(0,0,0,0.9),0_0_0_1px_rgba(255,255,255,0.03)]">
                  ...
                  <div key={stage} className="sfp-fade">
                    ...
                    <h3 className="mt-1 text-[14px] leading-snug text-white">
                      {st.title}
                    </h3>
              ...
              {/* Marchas 1–6 */}
              <div className="mt-6 flex items-center justify-center gap-2" role="group" aria-label="Marchas">
                {[1, 2, 3, 4, 5, 6].map((g) => (
                  <button
                    key={g}
                    type="button"
              ...
              <div className="mx-auto mt-6 max-w-[560px]">
                <div className="mb-2 flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <svg viewBox="0 0 16 20" className="h-5 w-3.5" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" aria-hidden="true">
                ...
                <p className="mt-2 text-center text-[11px] leading-snug text-white/45">
                  Arraste para descobrir como cada área do Super Fast transforma a
                  gestão da sua oficina.
                </p>
              </div>
            </div>
